...
| Public-data, secret and state controls | workflow/public layout | Partial | Partial | BLOCKED: remote repository/secret unavailable |
...
| CI, PR, merge, schedule and ChatGPT monitor | Production Gate | Scaffolded | No | BLOCKED: no new remote repository |
